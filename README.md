...
Measured with [`cargo-llvm-cov`](https://github.com/taiki-e/cargo-llvm-cov) (LLVM instrumentation), across **173 tests** (150 unit + 23 SQLite integration):

```
TOTAL   lines: 32.22%   functions: 34.91%   regions: 32.93%
```
