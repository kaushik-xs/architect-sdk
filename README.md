...
Measured with [`cargo-llvm-cov`](https://github.com/taiki-e/cargo-llvm-cov) (LLVM instrumentation), across **172 tests** (149 unit + 23 SQLite integration):

```
TOTAL   lines: 31.68%   functions: 34.74%   regions: 32.42%
```
