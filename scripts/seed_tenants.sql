-- Seed default tenants for the three strategies.
...
INSERT INTO architect._sys_tenants (id, strategy, database_url, schema_name, updated_at, comment)
VALUES
  (
    'default-mode-1',
    'database',
  ...
  (
    'default-mode-2',
    'schema',
    'postgres://localhost/temp_1',  -- use temp_1 DB for schema tenant; schema must exist or be created via apply_migrations with schema_override
    'tenant_default_mode_2',
    NOW(),
    'Tenant with own schema in shared DB'
  ),
  (
    'default-mode-3',
    'rls',
